...
const OUTPUT_FILE = path.join(__dirname, "..", "data", "hononegah.csv");

const API_URL = "https://manage-api.snap.app/";
const ORGANIZATION_ID = "Hononegah";
const HOME_ADDRESS = { address: "307 Salem St", city: "Rockton", state: "IL", zip: "61072" };
  ...
  return new Promise((resolve, reject) => {
    ...
    const req = https.request({
      ...
      headers: {
        ...
        "manage_organization_id": ORGANIZATION_ID,
...
async function main() {
  console.log("Hononegah High School Athletics Scraper");
  console.log("========================================\n");
  ...
  for (const ev of events) {
    ...
    const row = {
      ...
      endTime: ev.endTime || "",
      venue: ev.location || "",
      address: isHome ? HOME_ADDRESS.address : "",
      city: isHome ? HOME_ADDRESS.city : "",
      state: isHome ? HOME_ADDRESS.state : "",
      zip: isHome ? HOME_ADDRESS.zip : "",
  ...
  console.log(`\nDone! ${rows.length} events written to data/hononegah.csv (${skipped} cancelled skipped)`);
}
