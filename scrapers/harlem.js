...
const OUTPUT_FILE = path.join(__dirname, "..", "data", "harlem.csv");

const API_URL = "https://manage-api.snap.app/";
const ORGANIZATION_ID = "harlem";
const HOME_ADDRESS = { address: "1 Huskie Circle", city: "Machesney Park", state: "IL", zip: "61115" };
...
async function main() {
  ...
  console.log(`\nDone! ${rows.length} events written to data/harlem.csv (${skipped} cancelled skipped)`);
}
